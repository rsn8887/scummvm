...
bool SdlEventSource::handleControllerButton(SDL_Event &ev, Common::Event &event, bool buttonUp) {
	...
	static const ControllerEventMapping mapping[] = {
			...
			{ EVENT_KEYDOWN, KeyState(KEYCODE_F5, 0), EVENT_KEYDOWN, KeyState(KEYCODE_F5, 0) },
...
bool SdlEventSource::handleControllerAxisMotion(SDL_Event &ev, Common::Event &event) {
