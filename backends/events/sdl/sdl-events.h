...
#if SDL_VERSION_ATLEAST(2, 0, 0)
	virtual bool handleControllerButton(SDL_Event &ev, Common::Event &event, bool buttonUp);
	virtual bool handleControllerAxisMotion(SDL_Event &ev, Common::Event &event);
#endif
